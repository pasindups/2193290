    ...
    public String getFaultCode(String fault, String vehicleId)
    {
        ...
        for(String qty : FAULTS)
        {
            ...
            if(fault.contains(values[0]))
            {
                ...
                this.sendNotification("http://localhost/2193290/WebService/NotifyUserError.php?vehicle_id="+vehicleId+"&errormsg="+faultDesc);
                return values[1];
            }
        }
        return faultDesc;
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (status >= 1) {
                       Toast.makeText( null,"User Notified !", Toast.LENGTH_SHORT).show();
                    }
